...
<div class="row mt-5">
    <div class="col-md-8">
        <div class="card">
            <div class="card-body">
                <form action="{{ route('saw.index2') }}" method="GET" enctype="multipart/form-data">
                    @csrf
                    @method('GET')
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                ...
                <a href="{{ route('saw.htmltopdfview',['download'=>'pdf', 'waktu' => isset($_GET['waktu']) ? $_GET['waktu'] : date('Y-m-d') ]) }}" id="export" style="margin-left: 10px" class="btn btn-primary btn-xs">Export PDF</a>
                <table class="table">
                    <tr>
                        <td>Tekanan Udara</td>
