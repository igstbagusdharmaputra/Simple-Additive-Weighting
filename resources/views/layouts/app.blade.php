...
<body @if(Auth::check()) @if(Auth::user()->roles == '2') {{ "class=body-bg" }} @endif @endif>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datepicker/1.8.0/js/bootstrap-datepicker.min.js"></script>    <script src="{{ asset('js/jquery.slicknav.min.js') }}"></script>
